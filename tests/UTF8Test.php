...
class UTF8Test extends PHPTAL_TestCase
{
    ...
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>                                                                            |
        ...
        3.1.8  7 continuation bytes: "%80%BF%80%BF%80%BF%80"                                        |</p>'));
        ...
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>
            3.1.9  Sequence of all 64 possible continuation bytes %280x80-0xbf%29:            |
                ...
                "%80%81%82%83%84%85%86%87%88%89%8A%8B%8C%8D%8E%8F                                                          |
                 ...
                 %B0%B1%B2%B3%B4%B5%B6%B7%B8%B9%BA%BB%BC%BD%BE%BF"                                                         |</p>'));
    ...
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>3.2  Lonely start characters                                                  |
                                                                                       |
         3.2.1  All 32 first bytes of 2-byte sequences %280xc0-0xdf%29%2C                    |
                each followed by a space character:                                    |
                                                                                       |
            "%C0 %C1 %C2 %C3 %C4 %C5 %C6 %C7 %C8 %C9 %CA %CB %CC %CD %CE %CF                                           |
             %D0 %D1 %D2 %D3 %D4 %D5 %D6 %D7 %D8 %D9 %DA %DB %DC %DD %DE %DF "                                         |</p>'));
    ...
    function test3ByteSquences()
    {
        ...
        3.2.2  All 16 first bytes of 3-byte sequences %280xe0-0xef%29%2C                    |
               each followed by a space character:                                    |
                                                                                      |
           "%E0 %E1 %E2 %E3 %E4 %E5 %E6 %E7 %E8 %E9 %EA %EB %EC %ED %EE %EF "                                         |</p>'));
    ...
    function testIncompleteSequence()
    {
        ...
        3.3.3  4-byte sequence with last byte missing %28U%2B0000%29:     "%F0%80%80"               |</p>'));
    ...
    function testLastByteMissing1()
    {
        ...
        3.3.7  3-byte sequence with last byte missing %28U-0000FFFF%29: "%EF%BF"               |</p>'));
    ...
    function testImpossibleBytes()
    {
        ...
        3.5.1  fe %3D "%FE"                                                               |
        3.5.2  ff %3D "%FF"                                                               |
        3.5.3  fe fe ff ff %3D "%FE%FE%FF%FF"                                                   |--></p>'));
    ...
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>    <![CDATA[                                                                        |
        4.1.1 U%2B002F %3D c0 af             %3D "%C0%AF"                                        |
        4.1.2 U%2B002F %3D e0 80 af          %3D "%E0%80%AF"                                        |
        4.1.3 U%2B002F %3D f0 80 80 af       %3D "%F0%80%80%AF"                                        |]]></p>'));
    ...
    function testOverlong1()
    {
        ...
        4.1.5 U%2B002F %3D fc 80 80 80 80 af %3D "%FC%80%80%80%80%AF"                                        |</p>'));
    ...
    function testOverlong2()
    {
        ...
        4.2.2  U-000007FF %3D e0 9f bf          %3D "%E0%9F%BF"                                   |</p>'));
    ...
    function testOverlong3()
    {
        ...
        4.2.5  U-03FFFFFF %3D fc 83 bf bf bf bf %3D "%FC%83%BF%BF%BF%BF"                                   |]]></p>'));
    ...
    function testNUL()
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>4.3.1  U%2B0000 %3D c0 80             %3D "%C0%80"                                       |
         4.3.2  U%2B0000 %3D e0 80 80          %3D "%E0%80%80"                                       |
         4.3.3  U%2B0000 %3D f0 80 80 80       %3D "%F0%80%80%80"                                       |</p>'));
    ...
    function testNUL2()
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p title="4.3.4  U%2B0000 %3D f8 80 80 80 80    %3D "%F8%80%80%80%80"                                       |
         4.3.5  U%2B0000 %3D fc 80 80 80 80 80 %3D %FC%80%80%80%80%80   "/>'));
    ...
    function testUTF16()
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>5.1.1  U%2BD800 %3D ed a0 80 %3D "%ED%A0%80"                                                |
        ...
        5.1.7  U%2BDFFF %3D ed bf bf %3D "%ED%BF%BF"                                                |</p>'));
    ...
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>5.2.1  U%2BD800 U%2BDC00 %3D ed a0 80 ed b0 80 %3D "%ED%A0%80%ED%B0%80"                               |
        ...
        5.2.8  U%2BDBFF U%2BDFFF %3D ed af bf ed bf bf %3D "%ED%AF%BF%ED%BF%BF"                               |</p>'));
    ...
    {
        $tpl = $this->newPHPTAL()->setSource(rawurldecode('<p>5.3.1  U%2BFFFE %3D ef bf be %3D "%EF%BF%BE"                                                |
         5.3.2  U%2BFFFF %3D ef bf bf %3D "%EF%BF%BF"                                                |</p>'));
